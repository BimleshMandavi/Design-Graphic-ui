    ...
    <section className="bg-gray-900 py-8 sm:py-16 px-4 sm:px-6 lg:px-8 text-white">
      <div className="max-w-7xl mt-8 mx-auto">
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 mb-8 sm:mb-12">
          <Image src="/assets/park+.png" alt="Park+" width={100} height={50} className="w-24 sm:w-28" />
          ...
          <Image src="/assets/Screenshot 2025-01-04 145058.png" alt="RVshare" width={100} height={50} className="w-24 sm:w-28" />
          <Image src="/assets/apollo247.svg" alt="Apollo 247" width={100} height={50} className="w-24 sm:w-28" />
        </div>
